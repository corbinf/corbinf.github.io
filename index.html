...
<ol>
  ...
  <li><b>CIT 281 Web App Dev I:</b>"Unix, Git, RESTful Web Apps: NodeJS, Express, MongoDB."
    <blockquote>
      ...
      <ul>
        <li>
          <a href="https://uo-cit.github.io/project-5-corbinf/">Project 5</a>
          (<i>Includes information on all five projects</i>)
        </li>
        <li>Project 4</li>
        <li>Projcet 3</li>
        <li>Project 2</li>
  ...
  <li><b>CIS 110 Fluency With IT:</b>"Computer Science principles, HTML, CSS."
    <blockquote>
      <ul>
        <li><a href="https://pages.uoregon.edu/corbinf/110/">CIS 110 Projects</a></li>
      </ul>
    </blockquote>
  </li>
</ol>
